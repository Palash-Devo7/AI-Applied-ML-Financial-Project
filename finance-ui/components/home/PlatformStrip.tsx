export function PlatformStrip() {
  ...
  return (
    <div id="value" className="home-platform-strip" style={{ borderTop: "1px solid var(--home-border)", borderBottom: "1px solid var(--home-border)", padding: "20px 56px", display: "flex", alignItems: "center", gap: 48, background: "var(--home-bg2)" }}>
